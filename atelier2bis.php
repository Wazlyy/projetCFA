...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/atelier2bis.css">
</head>
...
<div class="col-12 zone_retour">
    ...
    <section class="container-fluid ctnr_at2">
        <div class="row">
            ...
            <div class="col-12 zone_boussole_at2bis">

                <svg class="img_boussole_at2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43.53 44.82">
                    <defs>
                        <style>
                            .cls-1 {
                                fill: #4cbfdd;
            ...
            <div class="col-12 zone_slider2_at2">
                ...
                <div class="col-12 multislider_at2">
                    ...
                    <p>- Agit toujours :</p>
                    <div class="container-fluid slidecontainer">
                        <span class="number" id="demo4"></span>
                        <br>
            ...
            <div class="col-3 zone_button_next">
                <a href="atelier3.php">
                    <svg class="button_next_at2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4.75 4.75">
                        <defs>
                            <style>
                                .cls-1,
                                .cls-3 {
    ...
    <script src="js/slide4.js" type="text/javascript"></script>
</body>
